...
summary: Ante la no celebración este año de las Jornadas de SIG Libre de Girona,
  ...
  Camp España 2026. Para ello, se propone mantener un formato participativo con
  presentaciones, talleres, lightning talks y desconferencias, y se plantea una
  encuesta abierta a la comunidad con el fin de medir el apoyo real al evento y
  estimar el posible quorum de asistencia, especialmente entre dos sedes
  candidatas, Madrid y Granada. El objetivo es tomar una decisión informada y
  transparente, basada en la participación de la comunidad, a la que se anima a
  responder la encuesta y difundirla para que llegue al mayor número posible de
  personas usuarias de QGIS.
draft: false
featured: false
image:
  filename: qgis-camp-2026.png
  focal_point: Smart
  preview_only: false
---
...
Organizar un evento de estas características supone un esfuerzo considerable de coordinación, logística y difusión para el equipo de la Junta de la Asociación.
Antes de avanzar, queremos responder a dos preguntas clave:
...
[https://cloud.montera34.org/index.php/apps/forms/s/4pPR9gyYBnBw5eTrgT7Pj8xW](https://cloud.montera34.org/index.php/apps/forms/s/4pPR9gyYBnBw5eTrgT7Pj8xW "https\://cloud.montera34.org/index.php/apps/forms/s/4ppr9gyybnbw5etrgt7pj8xw")
